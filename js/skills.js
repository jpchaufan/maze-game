...
function applyIcebolt(){
	console.log('test');
	$('.abilitiesMenuMagic').append('<div class="infoAbility" handle="Icebolt"><div class="top"><div class="abilityName">Icebolt</div> <div class="remove">-</div><div class="add">+</div></div><div class="abilityInfo">Deal 1x magic damage and delay enemy by 25%.</div> </div>');
}
